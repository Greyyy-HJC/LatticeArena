...
def auto_ylim(y_data, yerr_data, y_range_ratio=4):
    ...
    Args:
        ...
        y_range_ratio (float): The upper and lower blank space will be
            1/y_range_ratio times of the data range.
...
def default_sub_plot(height_ratio=3):
    ...
    Args:
        height_ratio (int): The ratio of heights between the upper and lower
            subplots. Default is 3.
